...
var expressServer = 'http://localhost:3011';
...
var fetchFunction = exports.fetchFunction = function fetchFunction(stuff) {
    ...
    var x = (0, _nodeFetch2.default)(jsonServer + '/' + stuff + '/' + uri).then(function (response) {
...
var createNewItem = exports.createNewItem = function createNewItem(title, imagurl, description, itemowner, tags) {
